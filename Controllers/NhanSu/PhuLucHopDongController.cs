...
namespace BatDongSan.Controllers.NhanSu
{
    public class PhuLucHopDongController : ApplicationController
    {
        ...
        public void SetModelData()
        {
            ...
            if (soPhuLuc != "")
            {
                model = (from pl in context.tbl_NS_PhuLucHopDongs
                         ...
                         join lhd in context.tbl_DM_LoaiHopDongLaoDongs on pl.maLoaiHopDong equals lhd.maLoaiHopDong into dtDong
                         from lhd2 in dtDong.DefaultIfEmpty()
                         ...
                         select new PhuLucHopDongModel
                         {
                             ...
                             tenLoaiHopDong = lhd2.tenLoaiHopDong,
            ...
            else
            {
                model = (from hd in context.tbl_NS_HopDongLaoDongs
                         join lhd in context.tbl_DM_LoaiHopDongLaoDongs on hd.maLoaiHopDong equals lhd.maLoaiHopDong into dtDong
                         from lhd2 in dtDong.DefaultIfEmpty()
        ...
        public void ThongTinPhuLucHopDong(string soPhuLuc)
        {
            ...
            model.tenLoaiHopDong = context.tbl_DM_LoaiHopDongLaoDongs.Where(d => d.maLoaiHopDong == model.maLoaiHopDong).Select(d => d.tenLoaiHopDong).FirstOrDefault() ?? string.Empty;
        ...
        public void GetAllDropdownList()
        {
            ...
            ViewBag.LoaiHopDongs = new SelectList(loaiHopDongs, "maLoaiHopDong", "tenLoaiHopDong", model.maLoaiHopDong);
