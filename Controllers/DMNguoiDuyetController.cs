...
namespace BatDongSan.Controllers
{
    public class DMNguoiDuyetController : ApplicationController
    {
        ...
        public ActionResult SelectCapDuyetDongERPCT1330(string id, string maCongViec, int? maQuiTrinhDuyet, string url)
        {
            ...
            try
            {
                ...
                ViewBag.MaCongViec = maCongViec;
                ViewBag.IDQuiTrinh = maQuiTrinhDuyet;
                ViewData["lisQuiTrinhDuyet"] = lqCT1330.sp_QuiTrinhDuyetAS(maCongViec).Select(d => new QuiTrinhDuyet
                {
                    Id = d.Id,
                    TenQuiTrinh = d.TenQuiTrinh,
                    ChuoiBuocDuyet = d.chuoiBuocDuyet,
        ...
        public ActionResult SelectCapDuyetDongERPCT2220(string id, string maCongViec, int? maQuiTrinhDuyet, string url)
        {
            ...
            try
            {
                ...
                ViewBag.MaCongViec = maCongViec;
                ViewBag.IDQuiTrinh = maQuiTrinhDuyet;
                ViewData["lisQuiTrinhDuyet"] = lqCT2220.sp_QuiTrinhDuyetAS(maCongViec).Select(d => new QuiTrinhDuyet
                {
                    Id = d.Id,
                    TenQuiTrinh = d.TenQuiTrinh,
                    ChuoiBuocDuyet = d.chuoiBuocDuyet,
        ...
        public ActionResult SelectCapDuyetDongERPNEWCITY(string id, string maCongViec, int? maQuiTrinhDuyet, string url)
        {
            ...
            try
            {
                ...
                ViewBag.MaCongViec = maCongViec;
                ViewBag.IDQuiTrinh = maQuiTrinhDuyet;
                ViewData["lisQuiTrinhDuyet"] = lqCTNewCity.sp_QuiTrinhDuyetAS(maCongViec).Select(d => new QuiTrinhDuyet
                {
                    Id = d.Id,
                    TenQuiTrinh = d.TenQuiTrinh,
                    ChuoiBuocDuyet = d.chuoiBuocDuyet,
        ...
        public JsonResult DuyetTheoQuiTrinhDongERP(string maPhieu, int? maQuiTrinh, string maCongViec, bool? sendMail, bool? sendSMS, string url)
        {
            ...
            try
            {
                ...
                List<BatDongSan.Models.NhanSu.LinqThuanViet.HT_DMNguoiDuyet> listND = new List<BatDongSan.Models.NhanSu.LinqThuanViet.HT_DMNguoiDuyet>();
                BatDongSan.Models.NhanSu.LinqThuanViet.HT_DMNguoiDuyet nd;
                ...
                if (getDMNguoiDuyet == null)
                {
                    nd = new BatDongSan.Models.NhanSu.LinqThuanViet.HT_DMNguoiDuyet();
        ...
        public JsonResult DuyetTheoQuiTrinhDongERPCT1330(string maPhieu, int? maQuiTrinh, string maCongViec, bool? sendMail, bool? sendSMS, string url)
        {
            DMNguoiDuyetController _nguoiDuyet = new DMNguoiDuyetController();
            try
            {

                var duyetLuong = lqCT1330.tbl_DeNghiChiLuongs.Where(d => d.maPhieu == maPhieu).FirstOrDefault();
                List<BatDongSan.Models.NhanSu.LinqCT1330.HT_DMNguoiDuyet> listND = new List<BatDongSan.Models.NhanSu.LinqCT1330.HT_DMNguoiDuyet>();
                BatDongSan.Models.NhanSu.LinqCT1330.HT_DMNguoiDuyet nd;
                var getDMNguoiDuyet = lqCT1330.HT_DMNguoiDuyets.Where(t => t.maPhieu.Equals(maPhieu)).OrderByDescending(t => t.ID).FirstOrDefault();

                DMNguoiDuyet item = new DMNguoiDuyet();
                string error = "";
                if (getDMNguoiDuyet == null)
                {
                    nd = new BatDongSan.Models.NhanSu.LinqCT1330.HT_DMNguoiDuyet();
                    nd.maCongViec = maCongViec;
                    nd.maPhieu = maPhieu;
                    nd.ngayDuyet = DateTime.Now;
                    nd.trangThai = 0;
                ...
                var buocDuyet = lqCT1330.sp_QuiTrinhDuyet_TrangTiepTheo(maQuiTrinh, maPhieu, 1).ToList();
                nd = new BatDongSan.Models.NhanSu.LinqCT1330.HT_DMNguoiDuyet();
                nd.maCongViec = maCongViec;
                nd.maPhieu = maPhieu;
                nd.ngayDuyet = DateTime.Now;
                ...
                nd.noiDung = duyetLuong == null ? string.Empty : duyetLuong.noiDung;
                listND.Add(nd);
                lqCT1330.HT_DMNguoiDuyets.InsertAllOnSubmit(listND);
                //Cập nhật mã qui trình duyệt                 
                duyetLuong.maQuiTrinhDuyet = maQuiTrinh;
        ...
        public JsonResult DuyetTheoQuiTrinhDongERPCT2220(string maPhieu, int? maQuiTrinh, string maCongViec, bool? sendMail, bool? sendSMS, string url)
        {
            DMNguoiDuyetController _nguoiDuyet = new DMNguoiDuyetController();
            try
            {

                var duyetLuong = lqCT2220.tbl_DeNghiChiLuongs.Where(d => d.maPhieu == maPhieu).FirstOrDefault();
                List<BatDongSan.Models.NhanSu.LinqCT2220.HT_DMNguoiDuyet> listND = new List<BatDongSan.Models.NhanSu.LinqCT2220.HT_DMNguoiDuyet>();
                BatDongSan.Models.NhanSu.LinqCT2220.HT_DMNguoiDuyet nd;
                var getDMNguoiDuyet = lqCT2220.HT_DMNguoiDuyets.Where(t => t.maPhieu.Equals(maPhieu)).OrderByDescending(t => t.ID).FirstOrDefault();

                DMNguoiDuyet item = new DMNguoiDuyet();
                string error = "";
                if (getDMNguoiDuyet == null)
                {
                    nd = new BatDongSan.Models.NhanSu.LinqCT2220.HT_DMNguoiDuyet();
                    nd.maCongViec = maCongViec;
                    nd.maPhieu = maPhieu;
                    nd.ngayDuyet = DateTime.Now;
                    nd.trangThai = 0;
                ...
                var buocDuyet = lqCT2220.sp_QuiTrinhDuyet_TrangTiepTheo(maQuiTrinh, maPhieu, 1).ToList();
                nd = new BatDongSan.Models.NhanSu.LinqCT2220.HT_DMNguoiDuyet();
                nd.maCongViec = maCongViec;
                nd.maPhieu = maPhieu;
                nd.ngayDuyet = DateTime.Now;
                ...
                nd.noiDung = duyetLuong == null ? string.Empty : duyetLuong.noiDung;
                listND.Add(nd);
                lqCT2220.HT_DMNguoiDuyets.InsertAllOnSubmit(listND);
                //Cập nhật mã qui trình duyệt                 
                duyetLuong.maQuiTrinhDuyet = maQuiTrinh;
        ...
        public JsonResult DuyetTheoQuiTrinhDongERPCTNEWCITY(string maPhieu, int? maQuiTrinh, string maCongViec, bool? sendMail, bool? sendSMS, string url)
        {
            DMNguoiDuyetController _nguoiDuyet = new DMNguoiDuyetController();
            try
            {

                var duyetLuong = lqCTNewCity.tbl_DeNghiChiLuongs.Where(d => d.maPhieu == maPhieu).FirstOrDefault();
                List<BatDongSan.Models.NhanSu.LinqERPNewCity.HT_DMNguoiDuyet> listND = new List<BatDongSan.Models.NhanSu.LinqERPNewCity.HT_DMNguoiDuyet>();
                BatDongSan.Models.NhanSu.LinqERPNewCity.HT_DMNguoiDuyet nd;
                var getDMNguoiDuyet = lqCTNewCity.HT_DMNguoiDuyets.Where(t => t.maPhieu.Equals(maPhieu)).OrderByDescending(t => t.ID).FirstOrDefault();

                DMNguoiDuyet item = new DMNguoiDuyet();
                string error = "";
                if (getDMNguoiDuyet == null)
                {
                    nd = new BatDongSan.Models.NhanSu.LinqERPNewCity.HT_DMNguoiDuyet();
                    nd.maCongViec = maCongViec;
                    nd.maPhieu = maPhieu;
                    nd.ngayDuyet = DateTime.Now;
                    nd.trangThai = 0;
                ...
                var buocDuyet = lqCTNewCity.sp_QuiTrinhDuyet_TrangTiepTheo(maQuiTrinh, maPhieu, 1).ToList();
                nd = new BatDongSan.Models.NhanSu.LinqERPNewCity.HT_DMNguoiDuyet();
                nd.maCongViec = maCongViec;
                nd.maPhieu = maPhieu;
                nd.ngayDuyet = DateTime.Now;
                ...
                nd.noiDung = duyetLuong == null ? string.Empty : duyetLuong.noiDung;
                listND.Add(nd);
                lqCTNewCity.HT_DMNguoiDuyets.InsertAllOnSubmit(listND);
                //Cập nhật mã qui trình duyệt                 
                duyetLuong.maQuiTrinhDuyet = maQuiTrinh;
