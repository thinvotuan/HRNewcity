...
namespace BatDongSan.Controllers.QLSuatAn
{
    public class DMCuaHangController : ApplicationController
    {
        ...
        //    QLSuatAnDataContext lQTVWindow = new QLSuatAnDataContext();

        //    var suatAnNhanVienTVWindows = lQTVWindow.sp_SA_DangKySuatAn_CongChuanNhanVien_NewCiTy(thang, nam).ToList();
