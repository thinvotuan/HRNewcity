...
namespace BatDongSan.Controllers.QLSuatAn
{
    public class PhieuDangKySuatAnController : ApplicationController
    {
        ...
        public ActionResult Create()
        {
            ...
            var checkPhieu = context.tbl_SA_PhieuAns.Where(d => d.maNhanVien == GetUser().manv && d.ngayLapPhieu.Value.Day == DateTime.Now.AddDays(1).Day && d.ngayLapPhieu.Value.Month == DateTime.Now.Month && d.ngayLapPhieu.Value.Year == DateTime.Now.Year).FirstOrDefault();
            ...
            var timeTo = new DateTime(DateTime.Now.Year,DateTime.Now.Month,DateTime.Now.Day,11,00,00);
            // Check 1330 
        ...
        public ActionResult LoadDanhSachCuaHang(string id)
        {
            ...
            listLuuVet = linqSALuuVet.sp_SA_PhieuDangKySuatAn_CuaHang_LuuVet_PhanBo(id, System.Configuration.ConfigurationManager.AppSettings["CongTy"].ToString()).ToList();
            ...
            try
            {
                ...
                if (checkQuyen == false)
                {
                    ...
                    var checkPhieu = context.tbl_SA_PhieuAns.Where(d => d.maNhanVien == GetUser().manv
                        && d.ngayLapPhieu.Value.Day == DateTime.Now.AddDays(1).Day && d.ngayLapPhieu.Value.Month == DateTime.Now.Month
                ...
                if (listLuuVet.tongSoSuatConLaiCuaCuaHangTrongNgay > 0 && listLuuVet.soLanNhanVienDuocDangKyTrongThang > 0)
                {
                    ...
                    tblSALuuVet.ngayDangKy = tblPhieuAn.ngayLapPhieu ?? DateTime.Now.AddDays(1);
        ...
        public ActionResult PartialPrintSuatAn(string searchString, string maPhongBan)
        {
            ...
            var thongTinPhieu = (from p in context.tbl_SA_PhieuAns
                                 ...
                                 && DateTime.Now.Year == p.ngayLapPhieu.Value.Year && DateTime.Now.AddDays(1).Day == p.ngayLapPhieu.Value.Day
                                 select new PhieuDangKySuatAnModel
                                 {
                                     maPhieu = p.maPhieu,
                                     maNhanVien = p.maNhanVien,
